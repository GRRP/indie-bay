...
/datum/gear/storage/white_vest
	allowed_roles = list(/datum/job/cmo, /datum/job/senior_doctor, /datum/job/doctor, /datum/job/merchant)
...
/datum/gear/accessory/ftupin
	allowed_roles = list(/datum/job/scientist, /datum/job/mining,
						 /datum/job/roboticist, /datum/job/psychiatrist,  /datum/job/bartender, /datum/job/merchant, /datum/job/assistant)